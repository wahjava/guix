      ...
      #~(modify-phases %standard-phases
          ...
          (add-after 'unpack 'patch-cmake-config-itk-path
            (lambda _
              ...
              ;; in the profile.
              (let ((itk #$(this-package-input "insight-toolkit"))
                    (itk-version #$(package-version
                                    (this-package-input "insight-toolkit")))
                    (itk-version-major+minor
                     #$(version-major+minor
                        (package-version
                         (this-package-input "insight-toolkit")))))
                (substitute* "SimpleITKConfig.cmake.in"
                  (((string-append "find_package\\(ITK \"@ITK_VERSION@\" "
                                   "EXACT REQUIRED\\)"))
                   (string-append "find_package(ITK \"" itk-version
