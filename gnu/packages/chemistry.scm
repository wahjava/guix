...
(define-public libcint
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1vlzgkgdhf94w3l1nk9rswf50sqbw4l9981hmnivgwwv905mq4ji"))
              (modules '((guix build utils)))
              (snippet
               '(begin
                  ;; Autogenerated code
         ...
         (add-after 'unpack 'adjust-build-path
           (lambda _
             (substitute* (find-files "testsuite" "\\.py$")
               (("\\.\\./\\.\\./build") "../../../build")))))))
    (inputs (list openblas))
    (native-inputs (list clisp python python-numpy))
...
and two-electron integrals for Gaussian type functions.")
    (license license:bsd-2)))
  ...
  (let ((commit "4eee5a430fb47eca5962f36fdcaf75c2b87e7ede")
    ...
    (package
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "0jzyfqhk6hcn1dpc311iiamc5dnwp71q5087432f5gqqvpg1zz94"))))
      (build-system pyproject-build-system)
      ...
      (description "This extension to python-pyscf provides calculations of
different electromagnetic properties for molecules and crystals.")
      (license license:asl2.0))))
