...
(define-public python-essentials-openapi
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (pypi-uri "essentials_openapi" version))
       (sha256
        (base32 "121mh8fna2y22a4nk6j46xdzmsixy6qicbxk8ch55ra8009h7byv"))))
    (build-system pyproject-build-system)
    ;; tests not distributed
    (arguments
     (list
      #:tests? #f))
    (propagated-inputs (list python-essentials python-markupsafe python-pyyaml))
...
(define-public python-guardpost
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (pypi-uri "guardpost" version))
       (sha256
        (base32 "152wwl436achkicqqz8c97nyrzvxdzair3gdfn1187603dn62rj5"))))
    (build-system pyproject-build-system)
    ;; unit tests not distributed
    (arguments
     (list
      #:tests? #f))
    (propagated-inputs (list python-rodi))
    (native-inputs (list python-hatchling python-pytest))
    (home-page "github.com/Neoteroi/GuardPost/")
    (synopsis
