  ...
  (package
    ...
    (arguments
     (list
      ...
      #~(list "-k"
              (string-append "not parallel_cocotb and " "not cocotb and "
                             "not vhdl_libraries_multiple"))
      #:phases
      #~(modify-phases %standard-phases
    ...
    (description
     "Coroutine based cosimulation test bench environment for verifying VHDL and
Verilog RTL using Python.")
