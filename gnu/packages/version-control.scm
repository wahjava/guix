...
(define-public git-repo-go
  (package
    ...
    (description "@command{git-repo} provides Git extensions for interacting
conveniently with AGit-Flow or Gerrit servers.  It makes it possible to
create, update or fetch @acronym{PR, pull requests}, and more.  It is based on
the @command{repo} tool that was developed for the Gerrit project, but also
