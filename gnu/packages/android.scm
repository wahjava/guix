     ...
     (list #:make-flags
           ...
           #~(modify-phases %standard-phases
              ...
              (add-before 'build 'patch-calloc-order
                 ;; As of the 1.1.5 release, the calloc argument order is wrong,
                 ;; and GCC 14 recognises this. We correct it here.
                 ;; When updating this package, remove these patches (fixed in master).
                 (lambda _
