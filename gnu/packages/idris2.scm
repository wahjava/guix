...
(define-module (gnu packages idris2)
  ...
  #:use-module (guix build-system idris2))

(define-record-type <idris2-source>
  (idris2-source origin version tag guix-version)
  idris2-source?
  (origin idris2-source-origin)
  (version idris2-source-version)
  (tag idris2-source-tag)
  (guix-version idris2-source-guix-version))
...
(define* (make-idris2-support idris2-source)
  (package
    (name "idris2-support")
    (version (idris2-source-guix-version idris2-source))
    (source
     (idris2-source-origin idris2-source))
                   ...
                   (add-after 'install 'fix-paths
                     (lambda _
                       ...
                       (let* ((old-dir (string-append #$output "/idris2-"
                                                      #$(idris2-source-version idris2-source)))
...
(define* (make-idris2 idris2-source support
       ...
       (list
        #:make-flags #~(list (string-append "PREFIX="
                             ...
                             (string-append "VERSION_TAG="
                                            #$(idris2-source-tag idris2-source))
                       ...
                       (lambda* (#:key inputs #:allow-other-keys)
                         (let* ((lib-exec (string-append #$output "/libexec/idris2.so"))
                                (package-path (format #f "~a/lib/idris2-~a"
                                                      #$output
                                                      #$(idris2-source-version idris-source)))
                           ...
                           (rename-file
                            (string-append #$output "/idris2-" #$(idris2-source-version idris2-source))
                            package-path)))))))
...
(define (idris2-git-source version commit tag hash)
...
(define %idris2-source-root
  (idris2-git-source "0.7.0" "034f1e89c4c58cdd59aabe2b0d0fe4e9ff3411f6"
                    "50-g034f1e89c"
                    "1b6yvarydyk2m1q82hg96f2rfywda42i4cw66jzbm71fvg84ya2k"))

(define idris2-support-root
  (make-idris2-support %idris2-source-root))

(define idris2-bootstrap-root
  (package
    (inherit (make-idris2 %idris2-source-root idris2-support-root))
    (name "idris2-bootstrap")))

(define idris2-root
  (make-idris2 %idris2-source-root idris2-support-root
...
(define %idris2-source-git
  (idris2-git-source "0.7.0" "0659bcc2c0c8b437affd9d33b62668f0b08c74f7"
                    "268-g0659bcc2c"
                    "1chjy0gnrsgb205rhxridbpp7nf72922mg1cx6mg1gkl9z97ad1j"))

(define-public idris2-support-git
  (package
    (inherit (make-idris2-support %idris2-source-git))
    (name "idris2-support-git")
    (properties '((hidden . #t)))))

(define-public idris2-git
  (package
    (inherit (make-idris2 %idris2-source-git idris2-support-git
...
(define-public idris2-api
  (let ((idris2-source %idris2-source-root))
    (package
      (name "idris2-api")
      (version (idris2-source-guix-version idris2-source))
      (source (idris2-source-origin idris2-source))
      ...
      (arguments
       (list
        #:ipkg-name "idris2api"
        #:phases #~(modify-phases %standard-phases
                     (add-before 'build 'make-idris2-paths
                       (lambda* _
                         (invoke "make"
                                 (string-append "VERSION_TAG="
                                                #$(idris2-source-tag idris2-source))
