...
(define-public xmedcon
  (package
    ...
    (description
     "@acronym{(X)MedCon, Medical Image Conversion} can be used to convert between
different file formats used in medical imaging.  The supported formats are
@acronym{ACR, American College of Radiology}-@acronym{NEMA, National
