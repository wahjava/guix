...
(define-public postgresql-backup-scripts
  (package
    ...
    (source (origin
              ...
              (uri (git-reference
                    (url
                     (string-append "https://codeberg.org/fishinthecalculator/"
                                    "postgresql-backup-scripts"))
                    (commit version)))
              (file-name (git-file-name name version))
              (sha256
               (base32
                "0ig19345p9h2z56k07i6g94pls2b4fhxacf1i8f0hxvk2p4x730k"))))
    ...
    (inputs
     (list coreutils
           ...
           postgresql))
    (home-page
     "https://codeberg.org/fishinthecalculator/postgresql-backup-scripts")
    (synopsis
     "Utility scripts for PostgreSQL backups")
    (description
