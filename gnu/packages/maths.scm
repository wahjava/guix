  ...
  (let ((commit "63b90a07704acab5b04acc7a9335a8a88916c402") ; no releases
    ...
    (package
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "02smq8w0m3kj1xssbyd7kl17b34mk1jzy9ds7fsqb54qa5pba78q"))))
      (build-system pyproject-build-system)
      ...
      (description "This package provides a Mathics3 frontend for @url
{https://jupyter.org/,Jupyter Notebook} and @url{https://marimo.io/,Marimo}.")
      (home-page "https://mathics.org/")
      (license license:gpl3+))))
