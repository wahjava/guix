  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "19fz773par7lsfn4k7hhbn38ccfqmy86a4pc4hrrp54ji6vwgk8m"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1znxkva2c3iyp188kq2xxcya5v5ykgwnivrw83cd8jbdk16r6yk1"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1fiyql0lrxjn0sz33kyn9akh5q7m3kr3v4pb2md4v924794nlin2"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1nn06lhcqkfj2ab32nz2z7dhszp44rs20zh0ydvpbvhfxnhl94cz"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "11pcimw31h8wh4ssh0sz0dg4d8g53rc9v9m8xfdlvv0ap89n50p2"))))
    (build-system go-build-system)
    (arguments
     (list
...
(define-public go-k8s-io-apiserver
  (package
    ...
    (propagated-inputs (list go-sigs-k8s-io-yaml
                        ...
                        go-github-com-evanphx-json-patch-v4
                        go-google-golang-org-protobuf
                        go-google-golang-org-grpc
                        go-google-golang-org-genproto-googleapis-api
                        go-golang-org-x-time
...
(define-public go-google-golang-org-grpc-examples
  (package
    ...
    (version "0.0.0-20250617043242-e5de1e2cac52")
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "10prrxcr5gjhkdyl8dxkj34c05y8d4mas8csfq8m2k8wd8m81lqc"))))
    (build-system go-build-system)
    (arguments
     (list
...
(define-public go-github-com-azure-azure-sdk-for-go-sdk-resourcemanager-internal-v2
  (package
    ...
    (propagated-inputs (list go-github-com-stretchr-testify
                        go-github-com-azure-azure-sdk-for-go-sdk-resourcemanager-resources-armresources
                        go-github-com-azure-azure-sdk-for-go-sdk-internal-v1
                        go-github-com-azure-azure-sdk-for-go-sdk-azidentity
                        go-github-com-azure-azure-sdk-for-go-sdk-azcore))
    (home-page "https://github.com/Azure/azure-sdk-for-go")
    (synopsis #f)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0grsnvkbwf98axahqrs25ajrdp34g9pfg90sy3zdwwhw3if36hn8"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0blqxpxrfv4bq97f7di9pjbh5ca5vzl1r5j9vlyz5zsqlb378cnw"))))
    (build-system go-build-system)
    (arguments
     (list
...
(define-public go-github-com-go-gomail-gomail
  (package
...
(define-public go-github-com-go-inf-inf
  (package
    ...
    (arguments
     (list
      #:import-path "github.com/go-inf/inf"))
...
(define-public go-github-com-bufbuild-protovalidate-go
  (package
    ...
    (synopsis "Notice")
    (description
     "@@strong{The import path for protovalidate-go has changed!} Please change your
import path(s) from @@code{github.com/bufbuild/protovalidate-go} to
@@code{buf.build/go/protovalidate}.")
    (license license:asl2.0)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1m7b95rck4ngrpbm9ma8ghnjq9pmh0267d2z343356bsw8j5zhl6"))))
    (build-system go-build-system)
    (arguments
     (list
    ...
    (propagated-inputs
     (list go-code-forgejo-org-forgejo-act
           ...
           go-github-com-go-testfixtures-testfixtures
           ...
           go-github-com-editorconfig-editorconfig-core-go
           go-github-com-dustin-go-humanize
           ...
           go-github-com-buildkite-terminal-to-html
