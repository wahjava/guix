  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "0kpm16pc44a4p86335prcd6zsvbdlvs48nwv770dh34ljhr6g00r"))))
    (build-system font-build-system)
    (arguments
     (list
      #:phases
...
on screens across a wide variety of devices and reading environments.

While the monospaced version is related to its variable width cousin, it doesn't hesitate
to change forms to better fit the constraints of a monospaced environment.")
    (license license:silofl1.1)))
