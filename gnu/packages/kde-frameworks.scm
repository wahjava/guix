...
(define-public kdbusaddons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0ifispgs8k95drw306b0c9pi2vrdmv0amrmwnw9qm8w3hiibk89v"))))
    (build-system qt-build-system)
    (native-inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://kde/stable/frameworks/"
                           ...
                           name "-" version ".tar.xz"))
       (sha256
        (base32 "0b8vlvx0w054gaiy9v18bpn2j9nbrdazyhwsgxlsdmwkf06s99sp"))))
    (build-system cmake-build-system)
    (arguments (list #:tests? #f))
    (native-inputs
...
(define-public kirigami
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "05jmyl55csn8ajd4i2p6brxkkwr0lyr49nwvryalylfqmhm19l8n"))))
    (build-system cmake-build-system)
    (arguments
     (list
      #:phases
...
(define-public kitemviews
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1p8ljamrw7b1d9q4a78z85h1l06gfgq077411cb6vc61bvc42mf4"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (arguments (list #:qtbase qtbase))
...
(define-public ksvg
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1hznbi7m596kdk92gyp9v30c1v88gz0n2p6d3h9pq4w4drrg0fzf"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (inputs
...
(define-public modemmanager-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "17pq4bv52fvz95fw4z94zq9pg8hq52phzzy5x5mrldf38kmjk69v"))))
    (build-system cmake-build-system)
    (native-inputs
...
(define-public networkmanager-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0ib6pn6155l5hgpjqh9wjf1vaz6ch2lligjifsn5mk2rj6m0pvdr"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules dbus pkg-config))
    (inputs (list qtbase))
...
(define-public pulseaudio-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0cg90i7a8zdcma6fvwm1p9j750cma819qdx9v7vkvk1bvmvdn63a"))))
    (build-system cmake-build-system)
...
(define-public qqc2-desktop-style
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1ry3cgzmb0sb07hkdpjqvbvfyysi39psqf4plgf5nv1c4cz2rc9s"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
...
(define-public solid
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "185qpqhj7504w7l8jh0fn474mav1q2jx99xnjzxvldckg6fn1v00"))))
    (build-system cmake-build-system)
    (native-inputs
...
(define-public kjobwidgets
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0ajbp7qazybac99rh61529isgqif6b0a53gkk9sxviwf33q06xsi"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (inputs
...
(define-public kpackage
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1jz3iqqfva5s9rjgcqm02ilniqh890vi23nxs76nafyv4q8cwpx4"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (propagated-inputs (list kcoreaddons))
...
(define-public baloo
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0r8z2zv47fmif53si40kimb171zjh9bp6g235s377c2slbngw9wc"))))
    (build-system cmake-build-system)
    (propagated-inputs
...
(define-public kdesu
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0s4dbjsrshjqw73z2d9y4x4c1yrd0jdchi4p4q5x1kwnhplgmjzr"))))
    (build-system cmake-build-system)
    (propagated-inputs
     (list kpty))
    (native-inputs
...
(define-public kservice
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "07h8rjqrfj73rciqa2i6qi2xkwxqigdy2v9y5pjx3a8mjgmcjppf"))))
    (build-system cmake-build-system)
    (propagated-inputs
