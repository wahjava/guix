...
(define-public mbake
  (package
    ...
    (description
     "@command{mbake} is a Makefile formatter and linter,
which is configurable via a TOML file.  It intelligently deals with
@code{.PHONY} declarations and line continuations, and ensures consistent
formatting and style for your Makefile.")
    (license license:expat)))
