...
(define-public libe-book
  (package
    ...
    (propagated-inputs ; in Requires or Requires.private field of .pkg
     (list icu4c liblangtag librevenge libxml2-next-for-grafting))
    (inputs
      (list boost))
    (arguments
     ;; avoid triggering configure errors by simple inclusion of boost headers
...
(define-public libcmis
  (package
    ...
    (propagated-inputs                  ;in Requires field of .pkg
     (list curl libxml2-next-for-grafting))
    (inputs
...
(define-public libabw
  (package
    ...
    (propagated-inputs ; in Requires or Requires.private field of .pkg
     (list librevenge libxml2-next-for-grafting))
    (inputs
     (list boost))
...
(define-public libetonyek
  (package
    ...
    (propagated-inputs ; in Requires or Requires.private field of .pkg
     (list liblangtag librevenge libxml2-next-for-grafting zlib))
    (inputs
     (list boost glm mdds))
