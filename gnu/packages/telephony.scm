...
(define-public baresip-libre
  (package
     ...
     (synopsis
      "Generic library for real-time communications with async @acronym{IO, Input Output} support,
forked by baresip")
...
(define-public baresip
  (package
    ...
    (synopsis
     "Portable and modular @acronym{SIP, Session Initiation Protocol} user agent
