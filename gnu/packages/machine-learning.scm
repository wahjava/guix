...
(define ctranslate2-version "4.6.0")
(define ctranslate2-source
  (origin
    (method git-fetch)
    (uri (git-reference
         (url "https://github.com/OpenNMT/CTranslate2")
         (commit ( string-append "v" ctranslate2-version))))
    (file-name (git-file-name "CTranslate2" ctranslate2-version))
  ...
  (package
    ...
    (arguments
     (list
      ...
      ;; so i think mkl and openblas are incompatible
