...
(define-public bemoji
  (package
    ...
    (synopsis "Emoji picker script for @code{dmenu}-like launchers")
    (description
     "Bemoji is an emoji picker script for @code{dmenu}-like launchers
(@code{bemenu}, @code{wofi}, @code{rofi}, @code{fuzzel}, etc.)  It will remember
your favorite emojis and give you quick access via a separately installed
clipboard tool (@command{wl-copy}, @code{xclip}, etc.), typing tool
(@code{wtype}, @code{xdotool}, etc.), or via standard output.")
